...
| 👨‍💻 이희용(백엔드) | 인증·인가, 인프라, 지도 서비스 | [![GitHub](https://img.shields.io/badge/eddie--backdev-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/eddie-backdev) |
| 👩‍💻 정현경(백엔드) | 제휴처 시스템, 이벤트 서비스, 관리자 페이지 | [![GitHub](https://img.shields.io/badge/hyunnk-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/hyunnk)                |
